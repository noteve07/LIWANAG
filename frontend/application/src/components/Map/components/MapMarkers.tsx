...
import { createLightIcon, getLuxColor, RoadType } from "../utils/mapUtils";
...
export const MapMarkers = ({
  ...
  const visiblePoints = useMemo(() => {
    ...
    console.log(
      `📍 Rendering ${filtered.length}/${points.length} markers in viewport`
    );
    return filtered;
