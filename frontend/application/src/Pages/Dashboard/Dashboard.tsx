      ...
      {loading ? (
        ...
        <div className="grid grid-cols-1 md:grid-cols-6 gap-4 flex-1 content-start">
          ...
          <div className="bg-gray-800 p-6 rounded-lg border border-gray-700 shadow-md md:col-span-2 relative">
              ...
              <span className="ml-2">
                ...
                >
                  <path
                    strokeLinecap="round"
                    strokeLinejoin="round"
                    d="M9 20l-5.447-2.724A2 2 0 013 15.382V6.618a2 2 0 011.105-1.794l5-2.5a2 2 0 011.79 0l5 2.5A2 2 0 0121 6.618v8.764a2 2 0 01-1.105 1.794L15 20m-6 0V8.382m0 11.618l6-3m0 0V8.382m0 11.618V8.382"
                  />
                </svg>
              </span>
            </h3>
            ...
            <p className="text-sm text-gray-400 mt-2">out of 331.91 km total</p>
          </div>
            ...
            <Card className="py-0 relative">
              <span className="absolute top-6 right-6 z-10">
                ...
                >
                  <path
                    strokeLinecap="round"
                    strokeLinejoin="round"
                    d="M12 3a6 6 0 00-6 6c0 2.5 1.5 4.5 3 6v3a3 3 0 006 0v-3c1.5-1.5 3-3.5 3-6a6 6 0 00-6-6z"
                  />
                </svg>
              </span>
              <CardHeader className="flex flex-col items-stretch border-b border-gray-700 pt-6 pb-4 px-6">
                <div className="flex flex-1 flex-col justify-center gap-1">
                  ...
                  <CardDescription>Current lighting levels</CardDescription>
                </div>
              </CardHeader>
