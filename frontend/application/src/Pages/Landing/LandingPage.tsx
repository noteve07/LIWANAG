  ...
  return (
    <div className="relative min-h-screen bg-[#121212] text-white overflow-hidden">
      ...
      <main className="relative z-10 flex flex-col pt-20">
        ...
        <section id="hero" className="relative overflow-hidden w-full bg-[#1a1a1a] border-b border-yellow-900/20">
          <div className="pointer-events-none absolute inset-0 bg-gradient-to-br from-yellow-500/10 via-transparent to-yellow-500/5" />
          
          <div className="relative mx-auto w-full max-w-6xl grid gap-10 px-4 sm:px-6 md:px-8 py-20 lg:grid-cols-[1.2fr_0.8fr] lg:items-center">
